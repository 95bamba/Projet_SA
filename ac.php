...
<div class="wrapper-main">
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="contact-details">
						<ul>
							<li><i class="fas fa-phone fa-rotate-90"></i> +221 33 961 25 20</li>
							<li><i class="fas fa-map-marker-alt"></i> Rue Hyane Sy, Ndioloféne Saint-Louis, Sénégal</li>
						</ul>
					</div>
				</div>
			</div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-light top-nav">
        <div class="container">
            <a class="navbar-brand" href="index.html">
				<img src="images/logoo.png" alt="logo" style="height: 90px; width: 120px;"/>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link active" href="#" id="navbarDropdownPortfolio" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Projets <i class="fas fa-sort-down"></i></a>
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
						<a class="dropdown-item" href="aea.php">Academy Ecole Aventure</a>
							<a class="dropdown-item" href="asn.php">Academy Science Numerique</a>
							<a class="dropdown-item" href="ace.php">Academy Challenge Entreprenariat</a>

							<a class="dropdown-item" href="mwa.php">Meting Women Academy</a>
							<a class="dropdown-item" href="ac.php">Academy Culture, Environnement, Sport et Santé</a>
							<a class="dropdown-item" href="aced.php">Academy Concours, Epelle-moi et Débattons</a>
							<a class="dropdown-item" href="af.php">Academy Formation</a>
							<a class="dropdown-item" href="ai.php">International Studies Academy</a>
							<a class="dropdown-item" href="#">SAIN'TIC</a>
						</div>
					</li>
					<li class="nav-item">
	...
	<div class="full-title">
		<div class="container">
			...
			<h1 class="mt-4 mb-3"> Academy Culture, Environnement, Sport & Santé </h1>
    ...
    <div class="item-pro">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8">
					<img class="img-fluid" src="images/dg.jfif" alt="" />
				</div>
				<div class="col-md-4">
			...
			<div class="related-projects">
				...
				<h3> Projects Réalisés</h3>
				<div class="row">
					<div class="col-md-3 col-sm-6 mb-4">
						<a href="#">
							<img class="img-fluid" src="images/54.jpg" alt="" />
						</a>
					</div>
					<div class="col-md-3 col-sm-6 mb-4">
						<a href="#">
	...
	<footer class="footer" style="background: #011b11; opacity: 80%;">
        <div class="container bottom_border">
            <div class="row">
				<div class="col-lg-4 col-md-6 col-sm-6 col">
					<h5 class="headin5_amrc col_white_amrc pt2">Rue Hyane Sy,Ndioloféne Saint-Louis, Sénégal</h5>
					<!--headin5_amrc-->
					<!--p class="mb10">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p-->
					
				</div>	
				<div class="col-lg-4 col-md-6 col-sm-6">
					<h5 class="headin5_amrc col_white_amrc pt2">+221 33 951 25 20</h5>
					<!--headin5_amrc-->
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col">
					<h5 class="headin5_amrc col_white_amrc pt2">contact.senegalacademy@gmail.com</h5>
        ...
        <div class="container">
            <p class="copyright text-center">All Rights Reserved. &copy; 2018 <a href="#">Senegal Academy</a> Concepté Par : 
				<a href="https://technofuturgroup.com/">Technofutur Group</a>
            </p>
...
@import url('https://fonts.googleapis.com/css?family=Work+Sans:100,200,300,400,500,600,700,800,900');
 ...
 /* ... [Tout le code CSS existant jusqu'au footer] ... */
 ...
 .footer .container.bottom_border {
   padding-bottom: 30px;
 }
 
 .footer h5.headin5_amrc {
   color: #ffffff;
   font-weight: 600;
   font-size: 18px;
   margin-bottom: 20px;
 ...
 /* ... [Tout le reste du code CSS existant] ... */
</style>
